    ...
    public static function execute(User $user)
    {
        ...
        $response = Http::withHeaders([
            ...
            ->post($baseURL, [
                ...
                'auth' => [
                    'type' => 'bank.account',
                    'secure' => encrypt($user->account_number), //encrypted_account_number
                ...
                'transaction' => [
                    ...
                    'transaction_desc' => 'Virtual account balance enquiry',
        ...
        if ($response['status'] === 'Successful') {
            ...
            return $response['data']['provider_response']['available_balance'];
        }
