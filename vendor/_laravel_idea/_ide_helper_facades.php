...
namespace Bugsnag\BugsnagLaravel\Facades {
    ...
    /**
     * @see \Bugsnag\Client::getMemoryLimitIncrease
     * @method static int|null getMemoryLimitIncrease()
     * @see \Bugsnag\Client::getNotifier
     * @method static string|string[] getNotifier()
     * @see \Bugsnag\Client::setProjectRoot
     * @method static void setProjectRoot(null|string $projectRoot)
     * @see \Bugsnag\Client::shouldCaptureSessions
     * @method static bool shouldCaptureSessions()
     * @see \Bugsnag\Client::getRedactedKeys
     * @method static string[] getRedactedKeys()
     * @see \Bugsnag\Client::makeGuzzle
     * @method static \GuzzleHttp\Client|\GuzzleHttp\ClientInterface makeGuzzle(null|string $base = null, array $options = [])
     * @see \Bugsnag\Client::getBuildEndpoint
     * @method static string getBuildEndpoint()
     * @see \Bugsnag\Client::getDiscardClasses
     * @method static array getDiscardClasses()
     * @see \Bugsnag\Client::deploy
     * @method static void deploy(null|string $repository = null, null|string $branch = null, null|string $revision = null)
     * @see \Bugsnag\Client::registerMiddleware
     * @method static \Bugsnag\Client registerMiddleware(callable $middleware)
     * @see \Bugsnag\Client::setBatchSending
     * @method static \Bugsnag\Client setBatchSending(bool $batchSending)
     * @see \Bugsnag\Client::setDiscardClasses
     * @method static \Bugsnag\Client setDiscardClasses(array $discardClasses)
     * @see \Bugsnag\Client::getSessionTracker
     * @method static \Bugsnag\SessionTracker getSessionTracker()
     * @see \Bugsnag\Client::setProjectRootRegex
     * @method static void setProjectRootRegex(null|string $projectRootRegex)
     * @see \Bugsnag\Client::getNotifyEndpoint
     * @method static string getNotifyEndpoint()
     * @see \Bugsnag\Client::getMetaData
     * @method static array[] getMetaData()
     * @see \Bugsnag\Client::shouldSendCode
     * @method static bool shouldSendCode()
     * @see \Bugsnag\Client::setAppVersion
     * @method static \Bugsnag\Client setAppVersion(null|string $appVersion)
     * @see \Bugsnag\Client::getPipeline
     * @method static \Bugsnag\Pipeline getPipeline()
     * @see \Bugsnag\Client::notifyError
     * @method static void notifyError(string $name, string $message, callable $callback = null)
     * @see \Bugsnag\Client::leaveBreadcrumb
     * @method static void leaveBreadcrumb(string $name, null|string $type = null, array $metaData = [])
     * @see \Bugsnag\Client::setMemoryLimitIncrease
     * @method static \Bugsnag\Configuration setMemoryLimitIncrease(int|null $value)
     * @see \Bugsnag\Client::isBatchSending
     * @method static bool isBatchSending()
     * @see \Bugsnag\Client::setErrorReportingLevel
     * @method static \Bugsnag\Client setErrorReportingLevel(int|null $errorReportingLevel)
     * @see \Bugsnag\Client::setStripPath
     * @method static void setStripPath(null|string $stripPath)
     * @see \Bugsnag\Client::setSessionEndpoint
     * @method static \Bugsnag\Client setSessionEndpoint(string $endpoint)
     * @see \Bugsnag\Client::setNotifier
     * @method static \Bugsnag\Client setNotifier(array $notifier)
     * @see \Bugsnag\Client::getFilters
     * @method static int|string[] getFilters()
     * @see \Bugsnag\Client::isInProject
     * @method static string isInProject(string $file)
     * @see \Bugsnag\Client::getSessionEndpoint
     * @method static string getSessionEndpoint()
     * @see \Bugsnag\Client::getApiKey
     * @method static string getApiKey()
     * @see \Bugsnag\Client::clearBreadcrumbs
     * @method static void clearBreadcrumbs()
     * @see \Bugsnag\Client::setFallbackType
     * @method static \Bugsnag\Client setFallbackType(null|string $type)
     * @see \Bugsnag\Client::setHostname
     * @method static \Bugsnag\Client setHostname(null|string $hostname)
     * @see \Bugsnag\Client::notify
     * @method static void notify(\Bugsnag\Report $report, callable $callback = null)
     * @see \Bugsnag\Client::setRedactedKeys
     * @method static \Bugsnag\Client setRedactedKeys(array $redactedKeys)
     * @see \Bugsnag\Client::setSendCode
     * @method static \Bugsnag\Client setSendCode(bool $sendCode)
     * @see \Bugsnag\Client::setFilters
     * @method static \Bugsnag\Client setFilters(array $filters)
     * @see \Bugsnag\Client::setAutoCaptureSessions
     * @method static \Bugsnag\Client setAutoCaptureSessions(bool $track)
     * @see \Bugsnag\Client::setNotifyReleaseStages
     * @method static \Bugsnag\Client setNotifyReleaseStages(array $notifyReleaseStages = null)
     * @see \Bugsnag\Client::setNotifyEndpoint
     * @method static \Bugsnag\Client setNotifyEndpoint(string $endpoint)
     * @see \Bugsnag\Client::getDeviceData
     * @method static array getDeviceData()
     * @see \Bugsnag\Client::flush
     * @method static void flush()
     * @see \Bugsnag\Client::getStrippedFilePath
     * @method static string getStrippedFilePath(string $file)
     * @see \Bugsnag\Client::setStripPathRegex
     * @method static void setStripPathRegex(null|string $stripPathRegex)
     * @see \Bugsnag\Client::setBuildEndpoint
     * @method static \Bugsnag\Client setBuildEndpoint(string $endpoint)
     * @see \Bugsnag\Client::make
     * @method static \Bugsnag\Client make(null|string $apiKey = null, null|string $notifyEndpoint = null, bool $defaults = true)
     * @see \Bugsnag\Client::setReleaseStage
     * @method static \Bugsnag\Client setReleaseStage(null|string $releaseStage)
     * @see \Bugsnag\Client::startSession
     * @method static void startSession()
     * @see \Bugsnag\Client::shouldIgnoreErrorCode
     * @method static bool shouldIgnoreErrorCode(int $code)
     * @see \Bugsnag\Client::registerDefaultCallbacks
     * @method static \Bugsnag\Client registerDefaultCallbacks()
     * @see \Bugsnag\Client::getConfig
     * @method static \Bugsnag\Configuration getConfig()
     * @see \Bugsnag\Client::getSessionClient
     * @method static \GuzzleHttp\ClientInterface getSessionClient()
     * @see \Bugsnag\Client::registerCallback
     * @method static \Bugsnag\Client registerCallback(callable $callback)
     * @see \Bugsnag\Client::setMetaData
     * @method static \Bugsnag\Client setMetaData(array $metaData, bool $merge = true)
     * @see \Bugsnag\Client::notifyException
     * @method static void notifyException(\Throwable $throwable, callable $callback = null)
     * @see \Bugsnag\Client::build
     * @method static void build(null|string $repository = null, null|string $revision = null, null|string $provider = null, null|string $builderName = null)
     * @see \Bugsnag\Client::shouldNotify
     * @method static bool shouldNotify()
     * @see \Bugsnag\Client::setAppType
     * @method static \Bugsnag\Client setAppType(null|string $type)
     * @see \Bugsnag\Client::getAppData
...
namespace Illuminate\Support\Facades {
     ...
     * @see \Illuminate\Http\Request::transformEnums
    ...
    /**
     * @see \Illuminate\Routing\Router::enum
...
namespace Spatie\Activitylog\Facades {
    ...
    /**
     * @see \Spatie\Activitylog\CauserResolver::resolve
     * @method static \Illuminate\Database\Eloquent\Model|null resolve(\Illuminate\Database\Eloquent\Model|int|null|string $subject = null)
     * @see \Spatie\Activitylog\CauserResolver::resolveUsing
     * @method static \Spatie\Activitylog\CauserResolver resolveUsing(\Closure $callback)
     * @see \Spatie\Activitylog\CauserResolver::setCauser
    ...
    /**
     * @see \Spatie\Activitylog\LogBatch::isOpen
     * @method static bool isOpen()
     * @see \Spatie\Activitylog\LogBatch::endBatch
     * @method static void endBatch()
     * @see \Spatie\Activitylog\LogBatch::startBatch
     * @method static void startBatch()
     * @see \Spatie\Activitylog\LogBatch::getUuid
     * @method static null|string getUuid()
     * @see \Spatie\Activitylog\LogBatch::setBatch
     * @method static void setBatch(string $uuid)
     * @see \Spatie\Activitylog\LogBatch::withinBatch
